      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-lg">+91 7019411903</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <div className="bg-blue-500 p-3 rounded-full">
              ...
              <div>
                ...
                <p className="text-lg">deepakgtalekar@gmail.com</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <div className="bg-blue-500 p-3 rounded-full">
              ...
              <div>
                ...
                <p className="text-lg">Telang road, Nandangadda, Karwar-581304.</p>
              </div>
            </div>
          </div>
          <div className="mt-6 flex space-x-4">
            ...
            <p className="text-lg">Deepak G. Talekar</p>
            </div>
          </div>
        </div>
